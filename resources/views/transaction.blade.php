                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="">{{$Txn_detail['TXHASH']}}</span></td>
                                        </tr>
                                        <tr>
                                            <td>Tx Receipient status:</td>
                                            @if($Txn_detail['TXNSTATUS']=='false')
                                        ...
                                        <tr>
                                            <td>Contract:</td>
                                            <td>{{$Txn_detail['TOADDRESS']}}</td>
                                        </tr>

                                        <tr>
                                            <td>From:</td>
                                            <td>{{$Txn_detail['FromToken']}}</td>
                                        </tr>

                                        <tr>
                                            <td>To:</td>
                                            <td>{{$Txn_detail['ToToken']}}</td>
                                        </tr>

                                        <tr>
                                            <td>Token Transfer:</td>
                                            <td>{{DashboardController::DisplayPrice($Txn_detail['NUMBEROFTOKENS'])}} DNC</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Time:</td>
                                            <td>
                                                {{date("d-F-Y H:i:s", substr($Txn_detail["TIME"], 0, 10))}}
                                            </td>
                                        </tr>

                                        <tr>
                                            <td>Nounce:</td>
                                            <td>{{$Txn_detail['Nounce']}}</td>
                                        </tr>
